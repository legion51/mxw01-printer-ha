...
</style></head><body><main><h1>MXW01 Printer 2.2</h1><div class="sub">Печать чеков, QR-кодов и изображений по Bluetooth <span id="state" class="status">проверка…</span></div>
